...
func test_equip_request_sets_equipment_and_returns_change() -> void:
	...
	assert_eq(outcome.changes[0].get("operation"), EntityEquipmentChangedGameEvent.OPERATION_SET)
...
func test_batch_can_unequip_and_equip_in_one_request() -> void:
	...
	assert_eq(outcome.changes[0].get("operation"), EntityEquipmentChangedGameEvent.OPERATION_UNSET)
	assert_eq(outcome.changes[1].get("operation"), EntityEquipmentChangedGameEvent.OPERATION_SET)
